...
public class SoundManager : MonoBehaviour
{
    ...
    public Sound gameplaybg;
   // public Sound carengineSound;
    public Sound button;
    public Sound coin;
    public Sound gameOver;
    public Sound CarStart;
    public Sound EngineSound;
    public Sound HitSound;
    public Sound levelcomp;
   ...
   // public AudioSource CarEngine;
    ...
    {
        CRPlaySound(sound, isSpecialSound, autoScaleVolume, maxVolumeScale);
    }

    void CRPlaySound(Sound sound, bool isSpecialSound = false, bool autoScaleVolume = true, float maxVolumeScale = 1f)
    {
    ...
    public void PlayMusic(AudioSource currentAudioSource,Sound music, bool loop = true)
    {
        currentAudioSource.clip = music.clip;
    ...
    {
        return PlayerPrefs.GetInt(SOUND_PREF_KEY, 1) == 0;
    }

    public void SetSoundOn(bool isOn)
    {
        int lastStatus = PlayerPrefs.GetInt(SOUND_PREF_KEY, 1);
        int status = isOn ? 1 : 0;
