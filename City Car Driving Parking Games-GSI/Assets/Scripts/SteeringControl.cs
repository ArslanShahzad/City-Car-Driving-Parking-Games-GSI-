...
namespace NWH.VehiclePhysics
{
    ...
    public class SteeringControl : MonoBehaviour
    {
        ...
        public static bool wheelBeingHeld = false;
        ...
        void Start()
        {
           ...
           //InitEventsSystem();
            UpdateRect();
            if(PlayerPrefs.GetInt("SecondAction") != 1)
            {
                maximumSteeringAngle = 150;
                returnToCenterSpeed = 0;
            }
            else
            {
                maximumSteeringAngle = 300;
                returnToCenterSpeed = 400;
            }
            //wheelAngle = 0;
        }
        ...
        public void PressEvent(BaseEventData eventData)
        {
            ...
            if (GamePlayTutManager.instance && PlayerPrefs.GetInt("SecondAction") != 1)
            {
                GamePlayTutManager.instance.PressSteering();
